...
export class EphemTable {
  constructor(table, units = DEFAULT_UNITS, ephemType = DEFAULT_EPHEM_TYPE) {
    ...
    if (
      units.distance !== DEFAULT_UNITS.distance ||
      units.time !== DEFAULT_UNITS.time
    ) {
